...
namespace Inceptum.Cqrs.Tests
{
    ...
    public class CommandDispatcherTests
    {
        ...
        public void WireTest()
        {
            ...
            dispatcher.Dispatch("test",CommandPriority.Normal, (delay, acknowledge) => { },new Endpoint());
            dispatcher.Dispatch(1, CommandPriority.Normal, (delay, acknowledge) => { }, new Endpoint());
        ...
        public void FailingCommandTest()
        {
            ...
            var handler = new Handler();
            dispatcher.Wire(handler);
            dispatcher.Dispatch(DateTime.Now, CommandPriority.Normal, (delay, acknowledge) => { ack = false; }, new Endpoint());
